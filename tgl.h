...
// JUST RANDOM STRING
#define TGL_BUILD "32489"
#define TGL_VERSION "2.0.0"
...
void tgl_do_reply_document (struct tgl_state *TLS, int flags, long long id, char *file_name, void (*callback)(struct tgl_state *TLS, void *callback_extra, int success, struct tgl_message *M), void *callback_extra);
